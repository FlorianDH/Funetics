...
public class Voormeting {
    ...
    public Voormeting(long id, int duikbril, int klimtouw, int kroos, int riet, int val, int kompas, int steil, int zwaan, int kamp, int zaklamp) {
        this.id = id;
